...
<head>
    ...
    <!-- META DISKRIPSI-->
    <meta name="description" content="Mari bergabung Bersama Kami di <?= $setting['nama_sekolah'] ?>, Pendaftaran Peserta didik Baru Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?> Kembali dibuka ">
    <meta name="keywords" content="tellapp v.1.1, tell madrasah, tell sekolah, web tel," />
                ...
                <nav class="navbar navbar-expand-lg navbar-light" id="navbar-header">
                    <a class="navbar-brand" href="javascript:;">
                        ...
                        <div class="home-header-text d-none d-sm-block">
                            ...
                            <h6>Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?></h6>
                        </div>
                        <span class="logo-mini-unbk d-block d-sm-none">PPDB </span>
                        <span class="logo-mini-tahun d-block d-sm-none">_SDN1PWTK</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="menu">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="http://localhost/oxeeds.github.io" id="link-website">Layanan Informasi Sekolah</a>
                            </li>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="1s">
                                                Aplikasi Penerimaan Peserta didik baru Tahun Pelajaran <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?> <?= $setting['nama_sekolah'] ?>.
                                            </p>
                                            <p data-animation="animated slideInRight" data-delay="2s">
                                                Pendaftaran Siswa dan Siswi Baru Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?> ini telah dibuka. Silahkan Segera Daftar dan lengkapi Formulir
                                            </p>
                                    ...
                                    <div class="carousel-item">
                                        <div>
                                            ...
                                            <h5 data-animation="animated fadeInDownBig">
                                                Tahun Pelajaran <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?>
                                            </h5>
                                            <ul>
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form-login">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" minlength="16" maxlength="16" onkeyup="this.value = this.value.toUpperCase()" class="form-control" name="username" placeholder="Masukkan Username (NIK Anak)" required autocomplete="off">
                                            <div class="error"></div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <br>
                                    <a href="#tentang" class="btn btn-success btn-block btn-login">
                                        Daftar Disini</a>
                    ...
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <form id="form-daftar">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="number" min="0" minlength="16" maxlength="16" class="form-control" name="nik" placeholder="NIK Anak" autocomplete="off" required>
                                                            <div class="error"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-10">
                                                                    <input type="number" min="0" minlength="10" maxlength="13" class="form-control" name="nohp" placeholder="No HP Whatsapp" required>
                                                                    <div class="error"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="tgllahir">TANGGAL LAHIRi</label>
                                                ...
                                                <div class="card-header bg-white">
                                                    <button id='btnsimpan' type="submit" class="btn btn-lg btn-primary rounded-pill">DAFTAR</button>
                                                </div>
                                            </form>
                                        </div>
                                    <?php } else { ?>
                                        <div class="card">
                                            ...
                                            <form id="form-daftar2">
                                                <div class="card-body">
                                                    <input type="date" name="tgl_daftar" class="form-control datepicker" value="<?= $daftar['tgl_daftar'] ?>" hidden>
                                                    <div class="form-row">
                                                        <label for="asal" class="required">Jalur / Program</label>
                                                        <select class="form-control" style="width: 100%" name="jurusan" id="jurusan" required>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label for="jenis" class="required">Jenis Pendaftaran Anak</label>
                                                            </select> -->
                                                            <select class="form-control" style="width: 100%" name="jenis" id="jenis" required>
                                                                <option value="">Pilih jenis daftar</option>
                                                                <?php $qu2 = mysqli_query($koneksi, "select * from jenis");
                                                                while ($jen = mysqli_fetch_array($qu2)) {
                                                                ?>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="nik" class="required">Username (NIK Anak)</label>
                                                            <input type="number" min="0" minlength="16" maxlength="16" class="form-control" name="nik" placeholder="NIK Anak" autocomplete="off" required>
                                                            <div class="error"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label for="nama" class="required">Nama Lengkap Anak</label>
                                                            <input type="text" class="form-control" name="nama" placeholder="Nama Lengkap" autocomplete="off" required>
                                                            <div class="error"></div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="nohp" class="required">No. WhatsApp (HP)</label>
                                                            <div class="row">
                                                                <div class="col-2">
                                                                    <input type="text" placeholder="+62" disabled style="width:45px" class="form-control">
                                                                </div>
                                                                <div class="col-10">
                                                                    <input type="number" min="0" minlength="10" maxlength="13" class="form-control" name="nohp" placeholder="Tanpa angka 0 (Misal 89612...)" required>
                                                                    <div class="error"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label for="tempat" class="required">Tempat Lahir Anak</label>
                                                            <input type="text" class="form-control" name="tempat" placeholder="Kota/Kab" required>
                                                            <div class="error"></div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="tgllahir" class="required">Tanggal Lahir Anak</label>
                                                            <input type="date" class="form-control" name="tgllahir" required>
                                                            <div class="error"></div>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword4" class="required">PASSWORD (Mohon Diingat!)</label>
                                                        <input type="password" class="form-control" name="password" id="inputPassword4" placeholder="Password" required>
                                                        <div class="error"></div>
                                                    </div>
                                                    <div class="form-row">
                                                ...
                                                <div class="card-footer">
                                                    <button id='btnsimpan' type="submit" class="btn btn-lg btn-success">Daftar Akun</button>
                                                </div>
                                            </form>
                                        </div>
                                    <?php } ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <p align="center">
                                    <img src="<?= $setting['favicon'] ?>" align="center" width="600" style="max-width: 100%" alt="Poster Alur PPDB" />
                                </p>
            ...
            <?php if ($awal <= $akhir) { ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="carousel-item active">
                                    <div>
                                        ...
                                        <p data-animation="animated slideInRight" data-delay="2s">
                                            Pendaftaran Siswa dan Siswi Baru Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?> ini Belum Dibuka.
                                        </p>
                                        <p data-animation="animated flipInX" data-delay="3s">
                                ...
                                <div class="card card-login bg-info">
                                    <div class="card-body">
                                        ...
                                        <form id="form-login">
                                            <div class="form-group">
                                                <span class="fa fa-user"></span>
                                                <input type="number" min="0" minlength="16" maxlength="16" onkeyup="this.value = this.value.toUpperCase()" class="form-control" name="username" placeholder="Masukkan Username (NIK Anak)" required autocomplete="off" disabled>
                                                <div class="error"></div>
                                            </div>
                                            <div class="form-group">
                                                <span class="fa fa-key"></span>
                                        ...
                                        <br>
                                        <a href="#tentang" class="btn btn-secondary btn-block btn-login">
                                            Daftar Disini</a>
                                            ...
                                            <form id="form-daftar">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="nik">NIK Anak</label>
                                                            <input type="number" min="0" minlength="16" maxlength="16" class="form-control" name="nik" placeholder="NIK Anak" autocomplete="off" disabled>
                                                            <div class="error"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-10">
                                                                    <input type="number" min="0" minlength="16" maxlength="16" class="form-control" name="nohp" placeholder="No HP Whatsapp" required>
                                                                    <div class="error"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date" class="form-control" name="tgllahir" disabled>
                                                        </div>
                ...
                <section class="bg-light statistik" id="persyaratan">
                    <div class="container">
                        ...
                        <h6 class="text-center">Peserta Didik Baru <?= $setting['nama_sekolah'] ?> Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?></h6>
                        <div class="row mt-12">
                            <div class="col-sm-6">
                                <div class="card mt-2">
                                            ...
                                            <div class="activities">
                                                <div class="activity">
                                                    ...
                                                    <div class="activity-detail">
                                                        ...
                                                        <p><a href="#tentang" class="btn btn-lg btn-success btn-block btn-login">
                                                                Klik Disini</a>.</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-sm" id="sortable-table">
                                                ...
                                                <tbody class="ui-sortable">
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT jurusan, COUNT(*) AS total_pendaftar FROM daftar GROUP BY jurusan");
                                                    if ($query) {
...
<!-- <script>
    ...
    // const nikEmpty = document.getElementById("empty-nik");
    // nama
    const namaInput = document.getElementById("nama");
    // const namaError = document.getElementById("nama-error");
    // const namaEmpty = document.getElementById("empty-nama");
    // nohp
    const nohpInput = document.getElementById("nohp");
    // const nohpError = document.getElementById("nohp-error");
    // const nohpEmpty = document.getElementById("empty-nohp");
    // tempat
    const tempatInput = document.getElementById("tempat");
    // const tempatError = document.getElementById("tempat-error");
    // const tempatEmpty = document.getElementById("empty-tempat");
    // tgllahir
    const tgllahirInput = document.getElementById("tgllahir");
    // const tgllahirError = document.getElementById("tgllahir-error");
    // const tgllahirEmpty = document.getElementById("empty-tgllahir");
    // password
    ...
    // valid
    // const validClasses = document.getElementById("valid");
    // error
    // const invalidClasses = document.getElementById("error");

    form.addEventListener('btnsimpan', e => {
    e.preventDefault();
    ...
    const validateInputs = () => {
        const nikInput = nik.value.trim();
        const namaInput = nama.value.trim();
        const nohpInput = nohp.value.trim();
        const tempatInput = tempat.value.trim();
        const tgllahirInput = tgllahir.value.trim();
        const passwordInput = password.value.trim();

        if(nikInput === '') {
            setError(nik, 'NIK harus diisi');
        } else if (nikInput.length < 16 ) {
            setError(nik, 'NIK terdiri dari 16 digit angka')
        } else {
            setSuccess(nik);
        }
        ...
        if(passwordInput === '') {
            ...
            setError(password, 'Password minimal 8 digit')
        } else {
            setSuccess(password);
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (json.pesan == 'ok') {
                    ...
                    setTimeout(function() {
                        $('#home').load('konfirmasi.php?id=' + json.id + '&nik=' + json.nik + '&pass=' + json.pass + '&nama=' + json.nama);
                    }, 2000);

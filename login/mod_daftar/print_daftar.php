...
$codeContents = $siswa['nik'] . '-' . $siswa['nama'];

//simpan file kedalam temp
//nilai konfigurasi Frame di bawah 4 tidak direkomendasikan

QRcode::png($codeContents, $tempdir . $siswa['nik'] . '.png', QR_ECLEVEL_M, 4);
...
<html>
    ...
    <body>
        ...
        <hr>
		<b><center>Formulir Pendaftaran Peserta Didik Baru Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?></center></b>
		<br>
		...
		<br>
            ...
            <tr>
                <td style="text-align: center">
                    <font size="1">
                        <img class="img" src="temp/<?= $siswa['nik'] ?>.png" ec="H" style="width: 30mm; background-color: white; color: black;">
                    </font>
                </td>

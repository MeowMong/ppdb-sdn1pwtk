                    ...
                    <table style="font-size: 12px" class="table table-striped table-sm" id="table-1">
                        <thead>
                            <tr>
                                ...
                                <th>Surat Tanda Tamat Belajar (STTB) TK/Sederajat</th>
                                <th>Akta</th>
                                <th>SKTM/KIP</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($daftar['ijazah'] <> null) { ?><a data-toggle="tooltip" data-placement="top" title="" data-original-title="Surat Tanda Tamat Belajar (STTB) TK/Sederajat" href="../<?= $daftar['ijazah'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-address-card    "></i></a><?php } ?>
                                    </td>
                                    <td>

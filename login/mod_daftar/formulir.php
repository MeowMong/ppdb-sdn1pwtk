                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            ...
                            <form id="form-datadiri">
                                ...
                                <div class="form-group row mb-2">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Pilihan Program/Jurusan</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <input type="number" min="0" minlength="16" maxlength="16" name="nohp" class="form-control" value="<?= $siswa['no_hp'] ?>" style="margin-left: 40px;">
                                        <div class="error"></div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <p class="required">* Kolom yang wajib diperhatikan, dimohon untuk teliti dalam menyeleksi berkas</p>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <select name="jarak" value="<?= $siswa['jarak'] ?>" class="form-control input-sm input-select" required>
                                            <option value="<?= $siswa['jarak'] ?>"><?= $siswa['jarak'] ?></option>

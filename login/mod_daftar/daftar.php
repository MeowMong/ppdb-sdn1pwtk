            ...
            <form id="form-tambah">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="jenis">Jenis Pendaftaran Anak</label>
                    ...
                    <div class="form-group">
                        <label>Username (NIK Anak)</label>
                        <input type="number" min="0" minlength="16" maxlength="16" name="nik" class="form-control" required>
                        <div class="error"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="jurusan">Jalur / Program</label>
                    ...
                    <div class="form-group">
                        <label>No HP</label>
                        <input type="number" min="0" minlength="10" maxlength="13" name="nohp" class="form-control" required>
                        <div class="error"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button id='btntambah' type="submit" class="btn btn-primary">Save</button>
                </div>
            </form>
        </div>
    </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=62<?= $daftar['no_hp'] ?>&text=Terima kasih telah mendaftar di <?= $setting['nama_sekolah'] ?>. Silahkan Login untuk melengkapi formulir pendaftaran dengan username *<?= $daftar['nik'] ?>%2A%0Apassword%20%3A%20%2A<?= $daftar['password'] ?>%2A">
                                            <?= $daftar['no_hp'] ?></a>
                                    </td>
                                    ...
                                    <td>
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Data Diri Pendaftar" href="?pg=ubahdaftar&id=<?= enkripsi($daftar['id_daftar']) ?>" class="btn btn-sm btn-info"><i class="fas fa-indent    "></i></a>
                                        <!-- Button trigger modal -->
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Cetak Formulir Pendaftar" href="mod_daftar/print_daftar.php?id=<?= enkripsi($daftar['id_daftar']) ?>" class="btn btn-sm btn-success"><i class="fas fa-print    "></i></a>
                                        <!-- Button trigger modal -->
                                        <a data-toggle="tooltip" data-placement="top" data-custom-class="custom-tooltip" data-title="Edit Data Pendaftar">
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-edit<?= $no ?>"><i class="fas fa-edit"></i></button>
                                        </a>
                                        <a data-toggle="tooltip" data-placement="top" data-custom-class="custom-tooltip" data-title="Edit Nilai Rapor Siswa (Opsional)">
                                            <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-nilai<?= $no ?>"><i class="fas fa-address-book"></i></button>
                                        </a>
                                        <a data-toggle="tooltip" data-placement="top" data-custom-class="custom-tooltip" data-title="Hapus Data Pendaftar">
                                            <button type="button" data-id="<?= $daftar['id_daftar'] ?>" class="hapus btn-sm btn btn-danger"><i class="fas fa-trash"></i></button>
                                        </a>
                                        <!-- Modal -->
                                                ...
                                                <div class="modal-content">
                                                    <form id="form-edit<?= $no ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label>NIK</label>
                                                                <input type="text" value="<?= $daftar['nik'] ?>" name="nik" class="form-control nik"="">
                                                            </div>
                                                            <div class="form-group">

        ...
        <div>
            ...
            <div class="twPc-divUser">
                <div class="twPc-divName">
                    <a href="<?= $setting['web'] ?>/admin"><b><?= $setting['nama_sekolah'] ?></b></a>
                </div>
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
                        <a href="https://ppdb.<?= $setting['web'] ?>" target="_blank" class="btn btn-danger">
                            <i class="fas fa-home"></i> Informasi PPDB
                        </a>
                    </li>
                </ul>

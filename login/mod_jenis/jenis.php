            ...
            <div class="modal-content">
                <form id="form-tambah">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data Jenis Pendaftaran</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Kode Jenis Pendaftaran</label>
                            <input type="text" name="id_jenis" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label>Nama Jenis Pendaftaran</label>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form id="form-edit<?= $no ?>">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Jenis Pendaftaran <?= $jenis['nama_jenis'] ?></h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>

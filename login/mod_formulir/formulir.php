                        ...
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            <form id="form-datadiri">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <input type="number" min="0" minlength="10" maxlength="10" name="nisn" class="form-control" value="<?= $siswa['nisn'] ?>" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <input type="number" min="0" minlength="16" maxlength="16" name="nik" class="form-control" value="<?= $siswa['nik'] ?>" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <input type="number" min="0" minlength="16" maxlength="16" class="form-control" value="<?= $siswa['no_kk'] ?>" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <input type="number" min="0" minlength="10" maxlength="13" name="nohp" class="form-control" value="<?= $siswa['no_hp'] ?>" required>
                                                <div class="error"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                            <form id="form-orangtua">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <input type="number" min="0" minlength="16" maxlength="16" name="nikayah" class="form-control" value="<?= $siswa['nik_ayah'] ?>" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <input type="number" min="0" minlength="16" maxlength="16" name="nikibu" class="form-control" value="<?= $siswa['nik_ibu'] ?>" required>
                                        <div class="error"></div>
                                    </div>
                                </div>
                                <div class="form-group row mb-2">

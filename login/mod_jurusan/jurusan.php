            ...
            <div class="modal-content">
                <form id="form-tambah">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data jalur</h5>
                    ...
                    <table class="table table-striped" id="table-1">
                        <thead>
                            <tr>
                                ...
                                <th>ID Jalur / Program</th>
                                <th>Nama Jalur / Program</th>
                                <th>Kuota</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                                                ...
                                                <div class="modal-content">
                                                    <form id="form-edit<?= $no ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="control-label">Status Jalur / Program</div>

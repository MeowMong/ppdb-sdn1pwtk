...
<html>
    ...
    <body>
        ...
        <hr>
		<b><center>Formulir Daftar Ulang Peserta Didik Baru Tahun <?php echo date("Y"); ?> / <?php echo date('Y', mktime(0, 0, 0, date('n'), date('j'), date('y') + 1)); ?></center></b>
		<br>
			...
			<tr>
				...
				<?php if ($siswa['jenis'] == "SB") { ?>
                                    <span class="badge badge-success">Siswa Baru</span>
                                <?php } elseif ($siswa['jenis'] == "KH") { ?>
                                    <span class="badge badge-success">Khusus</span>
                                <?php } elseif ($siswa['jenis'] == "PD") { ?>
                                    <span class="badge badge-success">Pindahan</span>
                                <?php } ?>
				</td>

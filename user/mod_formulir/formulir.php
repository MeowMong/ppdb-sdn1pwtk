                        ...
                        <div class="tab-content" id="myTabContent2">
                            <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                                <form id="form-datadiri">
                                    ...
                                    <div class="form-group row mb-2 required">
                                        <label class="required col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Pilihan Program/Jurusan</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="10" maxlength="10" name="nisn" class="form-control" value="<?= $siswa['nisn'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">NIK Anak</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="16" maxlength="16" name="nik" class="form-control" value="<?= $siswa['nik'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Kewarganegaraan</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Nama Lengkap</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="nama" class="form-control" value="<?= $siswa['nama'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Tempat Lahir Anak</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="tempat" class="form-control" value="<?= $siswa['tempat_lahir'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Tanggal Lahir</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" name="tgllahir" class="form-control" value="<?= $siswa['tgl_lahir'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Jenis Kelamin</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Anak Ke</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" name="anakke" class="form-control" value="<?= $siswa['anak_ke'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Jumlah Saudara</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" name="saudara" class="form-control" value="<?= $siswa['saudara'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Agama</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">No Handphone</label>
                                        <div class="col-sm-12 col-md-7">
                                            <div class="d-flex">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="6" maxlength="16" name="kip" class="form-control" value="<?= $siswa['no_kip'] ?>" placeholder="kosongkan jika tidak punya KIP">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="16" maxlength="16" name="nokk" class="form-control" value="<?= $siswa['no_kk'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                    ...
                                    <div class="form-group">
                                        <p>*Kolom wajib diisi, dimohon untuk mengisi data dengan sebenar-benarnya</p>
                            ...
                            <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                                <form id="form-alamat">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Status Tempat Tinggal</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">RT / RW</label>
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Desa / Perumahan / Kavling / dsb</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="desa" class="form-control" value="<?= $siswa['desa'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Kecamatan</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="kecamatan" class="form-control" value="<?= $siswa['kecamatan'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Kabupaten / Kota</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="kota" class="form-control" value="<?= $siswa['kota'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Provinsi</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="4" maxlength="8" name="kodepos" class="form-control" value="<?= $siswa['kode_pos'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                            ...
                            <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                                <form id="form-orangtua">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="16" maxlength="16" name="nikayah" class="form-control" value="<?= $siswa['nik_ayah'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Nama Ayah</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="namaayah" class="form-control" value="<?= $siswa['nama_ayah'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Tempat Lahir</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" name="tahunayah" class="form-control" value="<?= $siswa['tahun_ayah'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Pekerjaan Ayah</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="10" maxlength="13" name="nohpayah" class="form-control" value="<?= $siswa['no_hp_ayah'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="16" maxlength="16" name="nikibu" class="form-control" value="<?= $siswa['nik_ibu'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Nama Ibu</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="date" name="tahunibu" class="form-control" value="<?= $siswa['tahun_ibu'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pendidikan</label>
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Pekerjaan Ibu</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="10" maxlength="13" name="nohpibu" class="form-control" value="<?= $siswa['no_hp_ibu'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="16" maxlength="16" name="nikwali" class="form-control" value="<?= $siswa['nik_wali'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Nama Wali</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required">Pekerjaan Wali</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input type="number" min="0" minlength="10" maxlength="13" name="nohpwali" class="form-control" value="<?= $siswa['no_hp_wali'] ?>">
                                            <div class="error"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
